//the playerService will hold any business logic relating to the player. Directives will //be in a seperate directive folder
angular.module('turntify.player')
.factory('PlayerService', function (PlayerService) {
